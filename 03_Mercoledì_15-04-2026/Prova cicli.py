...
# Esistono 3 particelle funzionali per la gestione dei cicli
...
# Continue continua l'esecuzione del ciclo
for numero in numeri:
    if numero == 3:
        continue
    print(numero)

# Pass, quando non si vuole eseguire alcuna azione all'interno del ciclo
for numero in numeri:
    if numero == 3:
        pass
    print(numero)